...
class Query:
    ...
    def render(self, **kwargs):
        ...
        print('before render', self.context)
        self.reset_context()
        self.update_context(kwargs)
        print('before render after update', self.context)
        cp = {}
        cp.update(self.context)
        print(self, self.raw_query)
    ...
    def __call__(self, **kwargs):
        print('call', self.context)
        sql = self.render(**kwargs)
        print(sql)
        print('call after render', self.context)
    ...
    def _include_query(self, name):
        print('before include', name, self.context)
        print(self, self.raw_query)
        ...
        print('after include', self.context)
